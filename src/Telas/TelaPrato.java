...
private void construirTabela(){
    ArrayList<Prato> lista = Modelos.ModelPrato.getInstance().obterListaPrato();
        ...
        for (int i = 0; i < lista.size(); i++) {
            ...
            modelo.addRow(new String[]{
                        ...
                        p.getDescricaoPrato()+"",
                        p.getCategoriaPrato()+"",
                        "R$ "+formatter.format(p.getPrecoPrato())+"",});
        }

        jTablePratos.setModel(modelo);
    ...
    private void initComponents() {
        ...
        jTablePratos.setFont(new java.awt.Font("SansSerif", 3, 14)); // NOI18N
        jTablePratos.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null}
            },
            new String [] {
                "Nome", "Descricao", "Categoria", "Preço"
            }
        ));
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        ...
        Prato p = Modelos.ModelPrato.getInstance().listaPrato().get(linha);
        try {
            Modelos.ModelPrato.getInstance().excluirPrato(p);
        } catch (SQLException ex) {
            Logger.getLogger(TelaPrato.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(TelaPrato.class.getName()).log(Level.SEVERE, null, ex);
        }
        Modelos.ModelPrato.getInstance().obterListaPrato();
        construirTabela();
        jButtonEditar.setEnabled(false);
        jButtonExcluir.setEnabled(false);
    ...
    private void jButtonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarActionPerformed
        ...
        int linha = jTablePratos.getSelectedRow();
        Pessoa p = new Pessoa (nome, login, perfil, senha);
        Prato pr = Modelos.ModelPrato.getInstance().listaPrato().get(linha);
        new TelaAlterarPrato(p,pr).setVisible(true);
        this.dispose();
